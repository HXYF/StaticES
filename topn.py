...
def generate():
    ...
    with torch.no_grad():
        while True:
            task, source, source_mask, whole_word, user_ids, _ = topn_iterator.next_batch_test()  # data.step += 1
            ...
            beam_outputs = model.beam_search(task, source, whole_word, source_mask,user_ids,
